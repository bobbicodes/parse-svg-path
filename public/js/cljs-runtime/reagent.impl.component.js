...
if((i < len)){
var k = (ks[i]);
var G__40700 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__40701 = (i + (1));
m = G__40700;
i = G__40701;
continue;
...
var temp__5737__auto__ = (p["argv"]);
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__40590 = (p["children"]);
return module$node_modules$react$index.Children.toArray(G__40590);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__40592 = c;
var G__40592__$1 = (((G__40592 == null))?null:G__40592.prototype);
if((G__40592__$1 == null)){
return null;
} else {
return (G__40592__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__40594 = c;
var G__40594__$1 = (((G__40594 == null))?null:G__40594.prototype);
if((G__40594__$1 == null)){
return null;
} else {
return (G__40594__$1["render"]);
}
})() == null)))));
});
...
return (function() { 
var G__40703__delegate = function (args){
var G__40602 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__40602) : reagent.impl.component.as_element.call(null,G__40602));
};
...
while (G__40704__i < G__40704__a.length) {G__40704__a[G__40704__i] = arguments[G__40704__i + 0]; ++G__40704__i;}
  args = new cljs.core.IndexedSeq(G__40704__a,0,null);
} 
return G__40703__delegate.call(this,args);};
G__40703.cljs$lang$maxFixedArity = 0;
G__40703.cljs$lang$applyTo = (function (arglist__40705){
var args = cljs.core.seq(arglist__40705);
return G__40703__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__40603 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__40604 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__40604);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__40603);
}});
...
var c = this;
var G__40614_40708 = (c["cljsRatom"]);
if((G__40614_40708 == null)){
} else {
reagent.ratom.dispose_BANG_(G__40614_40708);
}
...
var renders_40709 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_40710 = cljs.core.first(cljs.core.vals(renders_40709));
if((cljs.core.count(renders_40709) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_40709))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_40710)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_40710], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__40615 = name;
switch (G__40615) {
case "":
...
var G__40627 = reagent.impl.component.cljsify(body);
return module$node_modules$create_react_class$index(G__40627);
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__40651 = fiber;
var G__40651__$1 = (((G__40651 == null))?null:(G__40651["type"]));
if((G__40651__$1 == null)){
return null;
} else {
return (G__40651__$1["displayName"]);
}
})();
var parent = (function (){var G__40652 = fiber;
if((G__40652 == null)){
return null;
} else {
return (G__40652["return"]);
}
})();
var path = (function (){var G__40653 = parent;
var G__40653__$1 = (((G__40653 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__40653) : reagent.impl.component.fiber_component_path.call(null,G__40653)));
if((G__40653__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__40653__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4185__auto__ = (function (){var G__40655 = c;
if((G__40655 == null)){
return null;
} else {
return (G__40655["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__40656._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4185__auto__ = (function (){var G__40658 = c;
if((G__40658 == null)){
return null;
} else {
return (G__40658["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var or__4185__auto____$1 = (function (){var G__40660 = c;
if((G__40660 == null)){
return null;
} else {
return G__40660._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4185__auto__ = (function (){var G__40662 = instance;
if((G__40662 == null)){
return null;
} else {
return (G__40662["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var G__40663 = instance;
if((G__40663 == null)){
return null;
} else {
return G__40663._currentElement;
}
}
})();
var name = (function (){var G__40664 = elem;
var G__40664__$1 = (((G__40664 == null))?null:(G__40664["type"]));
if((G__40664__$1 == null)){
return null;
} else {
return (G__40664__$1["displayName"]);
}
})();
var owner = (function (){var or__4185__auto__ = (function (){var G__40683 = elem;
if((G__40683 == null)){
return null;
} else {
return (G__40683["_owner"]);
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__40684._owner;
}
}
})();
var path = (function (){var G__40691 = owner;
var G__40691__$1 = (((G__40691 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__40691) : reagent.impl.component.component_path.call(null,G__40691)));
if((G__40691__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__40691__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__40692 = c;
var G__40692__$1 = (((G__40692 == null))?null:G__40692.constructor);
if((G__40692__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__40692__$1);
}
}
})();
