...
parse_svg_path.main.x_val = (function parse_svg_path$main$x_val(p__32096){
var vec__32097 = p__32096;
var command = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32097,(0),null);
var params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32097,(1),null);
var G__32100 = command;
switch (G__32100) {
case "C":
case "S":
case "Q":
...
parse_svg_path.main.y_val = (function parse_svg_path$main$y_val(p__32101){
var vec__32102 = p__32101;
var command = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32102,(0),null);
var params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32102,(1),null);
var G__32105 = command;
switch (G__32105) {
case "C":
case "S":
case "Q":
...
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"margin","margin",-995903681),"auto",new cljs.core.Keyword(null,"width","width",-384071477),"1000px"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h1","h1",-1896887462),"SVG Path Editor"], null),(function (){var vec__32106 = parse_svg_path.main.dimensions(cljs.core.deref(parse_svg_path.main.path));
var width = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32106,(0),null);
var height = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32106,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),["Width: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(width)," Height: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(height)].join('')], null)], null);
